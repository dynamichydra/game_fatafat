...
const mumbaiSuper = function () {
  this.code = 'mumbaiSuper';
...
mumbaiSuper.prototype.startGame = async function () {
  let _ = this;
...
mumbaiSuper.prototype.generateGame = async function (data) {
  ...
  let gameStartTime = [
    {'name':"MS1",start:"07:30:00",end:"10:00:00",duration:162},
    {'name':"MS2",start:"10:00:00",end:"11:30:00",duration:90},
    {'name':"MS3",start:"11:30:00",end:"13:00:00",duration:90},
    {'name':"MS4",start:"13:00:00",end:"14:30:00",duration:90},
    {'name':"MS5",start:"14:30:00",end:"16:00:00",duration:90},
    {'name':"MS6",start:"16:00:00",end:"17:30:00",duration:90},
    {'name':"MS7",start:"17:30:00",end:"19:00:00",duration:90},
    {'name':"MS8",start:"19:00:00",end:"20:30:00",duration:90}
  ];
  let _ = this;
...
mumbaiSuper.prototype.cancelAllBet = async function (data) {
  let _ = this;
  return new Promise(async function (result) {
    let conn = await sql.connectDB();
    let res = await sql.getData('game_inplay', {'where':[
...
mumbaiSuper.prototype.generateResult = async function (data) {
  let _ = this;
